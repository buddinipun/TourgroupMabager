...
if($done){
	...
	$sql = "UPDATE event SET event_theme ='$event_theme',event_type = '$event_type',  ,event_date = '$date',event_time = '$time',about_event = '$description', ,contact = '$contact_event',event_name = '$event_name',place = '$place',image = '$photo',latitude ='$latitude',longitude = '$longitude' where visits_visit_place_id = $event_id;"
